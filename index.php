...
<body>
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex  no-block justify-content-center align-items-center"
            style="background: url(assets/backend/assets/images/big/auth-bg.jpg) no-repeat center center;   background-size: cover;  ">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form class="form-horizontal mt-3 form-material" id="loginform" method="POST"
                                action="https://dms.toponsearch.in/login">
                                <input type="hidden" name="_token" value="stcYhpOO2kcnK3YBeEfoWdlZhH7yafxqqxHWJLpv" autocomplete="off">                                <div class="form-group mb-3">
                                    <div class="">
                                    ...
                                    <div class="d-flex">
                                        <div class="checkbox checkbox-info pt-0">
                                            ...
                                            <label for="checkbox-signup"><span
                                                    style="color: #fff;">Remember me</span></label>
                                        </div>
                                        <div class="ms-auto">
                                                                                            <a class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                                                    href="https://dms.toponsearch.in/forgot-password">
                                                    <span style="color: #fff;">Forgot pwd?</span>
